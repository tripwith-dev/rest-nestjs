...
1. 계획 세부 정보 가져옴: `GET plans/:planId`
...
4. 계획 메인 이미지 수정: `PATCH plans/:plaId/mainImage`

   - req:

   ```
    {
        "mainImage": "xxx/xxx.png"
    }
   ```
...
5. 계획 삭제: `PATCH plans/:planId/delete`
